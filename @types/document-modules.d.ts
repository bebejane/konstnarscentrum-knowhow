...
declare module '*/ActivityFragment.gql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
...
declare module '*/ActivityLightFragment.gql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
...
declare module '*/KnowledgeFragment.gql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
...
declare module '*/KnowledgeLightFragment.gql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
